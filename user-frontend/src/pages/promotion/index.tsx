...
export function PromotionPage() {
  ...
  return (
    <div className="shop-page">
      <Row gutter={24}>
        <Col xs={24} lg={12}>
          <Card title="可领优惠券" extra={<Button onClick={() => void loadTemplates()}>刷新</Button>}>
            <List
        ...
        <Col xs={24} lg={12}>
          <Card title="我的优惠券" extra={<Button onClick={() => void loadMyCoupons()}>刷新</Button>} style={{ marginTop: 24 }}>
            <List
